...
/// \file DataSamplingConditionTRandom1.cxx
...
class DataSamplingConditionTRandom1 : public DataSamplingCondition
{

 public:
  /// \brief Constructor.
  DataSamplingConditionTRandom1() : DataSamplingCondition(), mSeed(static_cast<uint64_t>(time(nullptr))), mFraction(0.0), mGenerator(0){};
  /// \brief Default destructor
  ~DataSamplingConditionTRandom1() = default;
...
std::unique_ptr<DataSamplingCondition> DataSamplingConditionFactory::createDataSamplingConditionTRandom1()
{
  return std::make_unique<DataSamplingConditionTRandom1>();
}
